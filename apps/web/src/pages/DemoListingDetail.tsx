    ...
    <div className="mx-auto w-full max-w-5xl space-y-6 px-4 py-6 md:px-6">
      <div className="grid gap-6 lg:grid-cols-5">
        <div className="lg:col-span-3">
          {hero ? (
            <div
              className="h-[220px] w-full overflow-hidden rounded-2xl bg-slate-100 sm:h-[240px] lg:h-[320px]"
          ...
          {thumbnails.length > 0 && (
            <div className="mt-3 grid grid-cols-4 gap-2">
              {thumbnails.map((img, idx) => (
                <div key={idx} className="h-12 overflow-hidden rounded-lg bg-slate-100 sm:h-14">
                  <img
                    src={img}
