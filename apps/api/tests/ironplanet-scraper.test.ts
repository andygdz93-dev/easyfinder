...
describe("scrapeIronPlanetSearch", () => {
  ...
  it("prefers buy now price over high offer", async () => {
  ...
  it("falls back to high offer when buy now missing", async () => {
    const searchUrl = "https://www.ironplanet.com/search-high-offer-fallback";
    const detailUrl =
      "https://www.ironplanet.com/for-sale/Excavators-Crawler-Excavators-Arizona/13861836";
    ...
    const listing = summary.sampleListings[0]!;
    expect(listing.price).toBe(40000);
  });
});
